...
"""
    ...
    print(f"[INFO] Calling OpenAI model: {OPENAI_MODEL}")
    raw = chat_completion(CONSTITUTION, prompt)
...
def main():
    ap=argparse.ArgumentParser(description="OpenAI API LinkedIn post engine")
